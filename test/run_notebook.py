...
package_path = Path(Path(__file__).parent, "../package").resolve()
...
if __name__ == "__main__":
    ...
    logger.addHandler(watchtower.CloudWatchLogHandler(log_group=log_group, stream_name=stream_name))
    # Add papermill logging to CloudWatch as well
    pm_logger = logging.getLogger("papermill")
    pm_logger.addHandler(watchtower.CloudWatchLogHandler(log_group=log_group, stream_name=stream_name))
    ...
    solution_notebooks = [
        "1_summarization",
        "2_question_answering",
        "3_entity_recognition",
        "4_relationship_extraction",
    ]
    kernel_name = "sagemaker-soln"
    test_prefix = "/home/ec2-user/SageMaker/test/"
    notebooks_directory = "/home/ec2-user/SageMaker/notebooks/"
